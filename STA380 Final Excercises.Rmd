...
author_dirs = Sys.glob('C:/MSBA22/STA380/Stats Repo/data/ReutersC50/C50train/*')
...
## COMBINING ALL 50 DIRECTORIES INTO ONE CORPUS 
test_author_dirs = Sys.glob('C:/MSBA22/STA380/Stats Repo/data/ReutersC50/C50test/*')
...
library(arulesViz)
groceries <- read.csv("C:/MSBA22/STA380/Stats Repo/data/groceries.txt", header=FALSE, sep=";")
...
```{r, echo=FALSE}
inspect(subset(groceryrules, subset=lift > 3.05))
heavylifters = subset(groceryrules, subset=lift > 3.05)
inspect(heavylifters)
